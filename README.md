...
As part of this trainning, we ignore the use of Branches, to avoid delay or more confusion. If some file is necesary to change due to part of this trainning course, we will create different versions of the file. 


# Links
- Getting started with writing & formatting on Git Hub
